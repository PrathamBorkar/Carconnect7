...
const styles = StyleSheet.create({
  ...
  banner: {
    ...
    height: 250, // Adjust height for banner section
  ...
  bannerphoto: {
    ...
    left: 0,
    width: '100%',
    height: '100%', // Ensures the banner image covers the entire banner
    resizeMode: 'cover', // This keeps the image properly scaled
  },
  wrapper: {
